    ...
    <>
      <Component
        style={{
          marginInline: "auto",
          background:
            "url(https://static-assets-web.flixcart.com/fk-p-linchpin-web/fk-cp-zion/img/background_1686f2.png) no-repeat top",
        }}
        className="mt-3 p-2 "
        height={"100vh"}
      >
        <Box
          style={{ width: "70%", paddingTop: "80px" }}
        ...
        >
          ...
          <Box
            className="d-flex flex-wrap align-item-center justify-content-center gap-5 my-5"
            style={{ fontSize: "14px" }}
          >
            <Box>
          ...
          <Box className="d-flex flex-wrap align-item-center justify-content-center gap-4 mt-4">
            ...
            >
              <img
                height="70px"
                src="https://static-assets-web.flixcart.com/fk-p-linchpin-web/fk-cp-zion/img/App-Store_50c61d.png"
              />
            </a>
            <a
            ...
            >
              <img
                height="70px"
                src="https://static-assets-web.flixcart.com/fk-p-linchpin-web/fk-cp-zion/img/Play-Store_33bb40.png"
              />
            </a>
          </Box>
        </Box>
