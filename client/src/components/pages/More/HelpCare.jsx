          ...
          <Grid container className=" mt-2">
            ...
            >
              <LeftComponent>
                <ListStyle
                  className="mb-2"
                  style={{ padding: "22px 16px 0 32px" }}
                >
                  <Typography
                    className="text-bold"
                    style={{ fontSize: "12px", color: "#212121" }}
                  >
                    TYPE OF ISSUE
                  </Typography>
                  <List>
                    <ListItem>
                      <Link to="" className="text-dark" component={routerLink}>
            ...
            >
              <Box>
                ...
                >
                  <Typography className="px-4 " style={{ fontSize: "18px" }}>
