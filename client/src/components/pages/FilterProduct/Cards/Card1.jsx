          ...
          <LeftComponent item lg={8}>
            <Grid container>
              <Grid item lg={3.5}>
                ...
                >
                  <Link>
                    <Image src={prod.url} alt="" />
                  </Link>
                  <Heart
                    style={{ fill: "#c2c2c2" }}
                    className="+7E521 bg-muted"
                  >
                    <svg
                ...
                <Box>
                  ...
                  <Box className="">
                    ...
                    <Typography
                      ...
                      style={{ fontSize: "15px" }}
                    >
                      {prod.content.rating.rating} &{" "}
                      {prod.content.rating.reviews}
                    </Typography>
                  </Box>
          ...
          <RightComponent item lg={3} style={{ marginInline: "auto" }}>
            <PriceComponent className="gap-1">
              ...
              <Box className="d-flex gap-2 align-item-center">
                ...
                >
                  {prod.content.price[1]}
                </del>
                <Typography
                  style={{ color: "green", fontSize: "13px" }}
                  className="text-bold"
                >
                  {prod.content.price[2]}
                </Typography>
              </Box>
              <Typography style={{ fontSize: "11px" }}>
                {prod.content.price[3]}
              </Typography>
              <Typography
                style={{ color: "green", fontSize: "14px" }}
                className="text-bold"
              >
                {prod.content.price[4]}
              </Typography>
            </PriceComponent>
          </RightComponent>
        </Component>
