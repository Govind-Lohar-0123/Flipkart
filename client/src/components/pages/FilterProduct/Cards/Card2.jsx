          ...
          <CardContent>
            <Box className="d-flex flex-direction-column gap-1">
              ...
              <Typography variant="small" style={{ fontSize: "12px" }}>
                {prod.content.clrTitle}
              </Typography>
              <Box className="">
                <Typography
                  variant="span"
                  className="px-1 py-1 border-rounded text-white text-bold"
                  style={{
              ...
              <Box className="d-flex gap-2 align-item-center">
                ...
                <del
                  style={{ fontSize: "14px" }}
                  className="text-muted text-bold d-inline-block"
                >
                  <del>{prod.content.price.org_price}</del>
                </del>
                <Typography
