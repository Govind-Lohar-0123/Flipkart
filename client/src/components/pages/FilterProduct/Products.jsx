      ...
      <Box className="p-2 px-4  w-100 " style={{ backgroundColor: "#FFFFFF" }}>
        <Box>
          <Box className=" text-muted mt-1" style={{ fontSize: "12px" }}>
            <List
              className="d-flex align-item-center gap-3 p-0 m-0"
            ...
            >
              ...
              <ListItem className="px-0  py-0 w-auto">
                <Link style={{ color: "#878787", transform: "rotate(180deg)" }}>
                  <svg
                    width="5"
                    height="10"
                    viewBox="0 0 16 27"
          ...
          <Box className="my-2 d-flex align-item-center">
            ...
            <Typography
              variant="span"
              className="mx-3 text-bold "
              style={{ fontSize: "12px", color: "#878787" }}
            >
              (Showing 1 – 14 products of 14 products)
            </Typography>
          </Box>
          ...
          <ListStyle className="d-flex  align-item-center mt-2">
            ...
            <ListItem
              ...
              style={sortBy == "Popularity" ? active : {}}
            >
              Popularity
            </ListItem>
            ...
            <ListItem
              onClick={(e) => setSortBy(e.target.textContent)}
              style={sortBy == "Price--Low to High" ? active : {}}
            >
              Price--Low to High
            </ListItem>
            ...
            <ListItem
              onClick={(e) => setSortBy(e.target.textContent)}
              style={sortBy == "Price--High to Low" ? active : {}}
            >
              Price--High to Low
            </ListItem>
            ...
            <ListItem
              onClick={(e) => setSortBy(e.target.textContent)}
              style={sortBy == "Newest First" ? active : {}}
            >
              Newest First
            </ListItem>
          </ListStyle>
        ...
        <Box className="mt-5">
          <Grid container lg={12} className="mx-auto">
            {prods
              .filter((prod) => prod.content.title.toLowerCase().includes(""))
              .map((prod, idx) => {
                return (
                  <>
                    <Grid
