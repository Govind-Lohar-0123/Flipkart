...
import {
  addFilter,
  removeFilter,
} from "../../react_redux/redux/actions/FilterActions";
...
export default function Filter() {
  ...
  useEffect(() => {
    document
      .querySelectorAll(".filter-component input")
      .forEach((item, idx) => {
      ...
      <FilterComponent className=" mx-2 bg-white filter-component">
        <ListItem className="p-2 px-3">
          <Box>
            <Box className="d-flex justify-content-space-between">
              ...
              <Typography
                variant="span"
                className=" text-primary text-small text-bold "
                style={{ fontSize: "12px" }}
              >
                CLEAR ALL
              </Typography>
            ...
            <FilteredItems
              className="d-flex gap-2 mt-2 filter-items"
              style={{ flexWrap: "wrap", fontSize: "12px" }}
            >
        ...
        <ListItem>
          <Box>
            ...
            >
              {" "}
              <ChevronLeftIcon /> Mobiles & Accessories..
            </Typography>
            <Typography className="px-2 text-bold" style={{ fontSize: "13px" }}>
              Smart Watches
            </Typography>
          </Box>
        </ListItem>
