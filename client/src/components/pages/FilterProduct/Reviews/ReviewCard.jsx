        ...
        <Component container lg={12}>
          ...
          >
            <Box>
              ...
              <Typography style={{ fontSize: "14px" }} className="my-2 ">
                {3}days
              </Typography>

              <Box className="d-flex gap-1 align-item-center">
                <p className="_2NsDsF AwS1CA m-0" style={{ fontSize: "13px" }}>
                  {"yes"}
                </p>
                <svg
                  width="14"
                ...
                <p
                  id="review-5aa457fd-3c5c-40a2-891c-0420d82154cc"
                  className="MztJPv m-0"
                >
                  <span style={{ fontSize: "13px" }}>Certified Buyer</span>
                </p>
                <p className="_2NsDsF m-0" style={{ fontSize: "13px" }}>
                  {"11-02-2023"}
                </p>
              </Box>
            </Box>
          ...
          >
            <Box>
              ...
              <Typography style={{ fontSize: "14px" }} className="my-2 ">
                ...
                totam eaque animi, similique magni nobis minus facere quod
