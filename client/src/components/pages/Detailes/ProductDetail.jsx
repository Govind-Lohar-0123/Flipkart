  ...
  return (
    <>
      <RightComponent>
        <ToolbarComponent className="">
          ...
          <Box className="d-flex flex-wrap" style={{ marginLeft: "auto" }}>
            ...
            <Box className="text-muted">
              <span style={{ transform: "rotate(160deg)" }}>
                <Reply />
              </span>
              <span>Share</span>
            </Box>
        ...
        <Typography className="" style={{ fontSize: "18px" }}>
          {content.title} (8 GB RAM) #JustHere
        </Typography>
        <Box className="my-2">
          <Typography
            variant="span"
            className="px-2 py-1 border-rounded text-white text-bold"
            style={{
          ...
          >
            ...
            <img
              ...
              className="Rza2QY my-auto"
              style={{ width: "12px" }}
            />
          </Typography>
          <Typography
            variant="span"
            className="text-muted mx-2 text-bold"
            style={{ fontSize: "15px" }}
          >
            {22} & {22}
          </Typography>
        ...
        <Typography style={{ color: "#388e3c", fontWeight: "bold" }}>
          Extra 40% Off
        </Typography>
        <PriceComponent className="my-1">
          <Typography className="text-bold" style={{ fontSize: "25px" }}>
            {content.price.sell_price}
          </Typography>
          <Typography variant="span" className="text-muted">
            {content.price.org_price}
          </Typography>
          <Typography
            variant="span"
        ...
        <Box className="my-2">
          ...
          <Box className="my-2">
            <Typography>
              <StyledBadge />{" "}
              <Typography variant="span" className="text-dark text-bold mx-1">
                Bank Offer{" "}
              </Typography>{" "}
              5% Cashback on Flipkart Axis Bank CardT&C{" "}
              <Typography variant="span">T&C</Typography>
            </Typography>
            ...
            <Typography>
              ...
              supercoins on booking<Typography variant="span">T&C</Typography>
            </Typography>
            <Typography className="my-2">
              <StyledBadge />
              <Typography variant="span" className="text-dark text-bold mx-1">
              ...
              Spotify Premium - 12M at ₹699T&C
              <Typography variant="span">T&C</Typography>
            </Typography>
          </Box>
        </Box>
        <Typography varaint="a" className="text-primary text-bold">
          View 4 more offers
        </Typography>
        <BuyChange className="my-3  text-center border border-muted">
          <Box
            style={{ backgroundColor: " #f5faff" }}
            className="border border-muted d-flex p-2 px-3 "
          >
            <FormControlLabel
              value="female"
          ...
          <Box className="p-2 px-3">
            ...
            <Typography
              ...
              className="text-muted "
            >
              Get extra ₹2,000 off on exchange of select models
            </Typography>
            <Typography className="text-danger my-2 text-bold">
        ...
        <TableStyle>
          <ColumnText>
            <TableCell className="text-muted">
              <Box className="SLT5t4">
                <img
                  className="border "
                  src="https://rukminim2.flixcart.com/image/60/100/prod-fk-cms-brand-images/dcb0a7e61ba5a05860ceee7e6948e00470cfbdff88a18c522461201f523a9006.jpg?q=90"
                />
              </Box>
            </TableCell>
            ...
            <TableCell className="text-dark" style={{ fontWeight: "bold" }}>
              <Box className="" style={{ width: "40%" }}>
                <Box
                  ...
                  className="d-flex align-item-center pb-1"
                >
                  <StyledTextField
                    id="standard-basic"
                    style={{ fontSize: "12px" }}
                    className="w-100 text-bold"
                    label="Enter Delivery Pincode"
                    variant="standard"
                  />
                  <Typography className="text-primary border-none mt-1 text-bold">
                    Check
                  </Typography>
                </Box>
                <Typography className="text-danger mt-2 tet-bold">
            ...
            <TableCell className="text-dark" style={{ fontWeight: "bold" }}>
              <Box className="mt-5 d-flex justify-content-space-between">
                ...
                <Box className="d-flex  gap-4 " style={{ marginRight: "" }}>
                  <Typography clasName="text-muted text-bold">
          ...
          <ColumnText>
            ...
            <TableCell>
              <Box>
                ...
                <Typography
                  variant="span"
                  className="px-2 py-1 border-rounded text-white text-bold mx-2"
                  style={{
              ...
              <ListStyleCircle className="my-2 text-bold">
        ...
        <Box className="border border-muted mt-4">
          <Typography variant="h5" className="p-3 border border-muted">
            Product Description
          </Typography>
          <Box>
            <Box className="px-3 py-2">
              <Box style={{ float: "left" }} className="px-3">
                <img
                  src="https://rukminim2.flixcart.com/image/200/200/cms-rpd-img/48c8228f2fd348d59d33df53c7355808_18f7be83116_Camera.jpg.jpeg?q=90"
                  style={{ maxWidth: "100%", verticalAlign: "middle" }}
                />
              </Box>
              <Box>
                <Typography variant="h6">
                  50 MP Ultra Pixel OIS Camera with Sony - LYTIA 700C Senor
                </Typography>
                <Typography>
                  Motorola edge 50 fusion is designed to capture its best shots
                  at night with advanced features. The 50 MP main camera uses a
                  powerful Sony LYTIA LYT-700C sensor to capture moments
                  ultrafast with low noise even in dark environments. Who
                  thought Night photography could get faster, accurate and
                  focused. An advanced all-pixel focus technology on the
                  Motorola Edge 50 Fusion elevates night photography by making
                  it 32x more focused. While the Ultra Pixel sensor captures
                  more light with larger 2.0µm pixels, the OIS automatically
                  smoothens involuntary hand motion to give you a shake free
                  video experience
                </Typography>
              </Box>
            </Box>
            ...
            <Box className=" px-3 py-2">
              <Box style={{ float: "right" }} className="px-3">
                <img
                  src="https://rukminim2.flixcart.com/image/200/200/cms-rpd-img/a3adbb5b89e74726a23d546603341b1f_18f7be85caf_Capturemagicalmoments.jpg.jpeg?q=90"
                  style={{ maxWidth: "100%", verticalAlign: "middle" }}
                />
              </Box>
              <Box>
                <Typography variant="h6">
                  4K Video Recording in 13MP Ultrawide+Macro Cam and 32 MP Front
                  Cam
                </Typography>
                <Typography>
                  Its advanced sensor gives two amazing perspectives. The 120
                  degree ultra-wide-angle lens captures what your eyes see,
                  fitting more of the scene in your frame than a standard lens.
                  So go ultra-wide or zoom in. The Macro Vision lens brings you
                  4x closer to your subject, so you see the tiniest of details.
                  The new Quad Pixel technology combines every four pixels into
                  one for 4x better low-light sensitivity giving you brilliant
                  results. Moreover, you can also capture videos in 4K
                  resolution from all cameras front and back and never miss a
                  detail.
                </Typography>
              </Box>
            </Box>
        ...
        <Box className="mt-5 border border-muted">
          <Box className="d-flex justify-content-space-between align-item-center px-3">
            <Typography variant="h5" className="p-3  text-bold">
              Ratings & Reviews
            </Typography>
            ...
            <Button
              ...
              className="bg-white text-bold text-dark py-3 "
            >
              Rate Product
            </Button>
          </Box>
              ...
              <Grid item lg={4} md={10} sm={12}>
                <RatingStyled className="d-flex gap-1 align-item-center w-100">
                  ...
                  <List style={{ fontSize: "12px" }}>
                    <ListItem>
                      <Typography variant="span">20,942</Typography>
                    </ListItem>
                    <ListItem>
                      <Typography variant="span">5,511</Typography>
                    </ListItem>
                    <ListItem>
                      <Typography variant="span">1,088</Typography>
                    </ListItem>
                    <ListItem>
                      <Typography variant="span">534</Typography>
                    </ListItem>
                    <ListItem>
                      <Typography variant="span">20,942</Typography>
                    </ListItem>
          ...
          <Box style={{ fontSize: "12px", padding: "25px" }}>
            <SpecifiTable>
              ...
              <ColumnText>
                ...
                <TableCell>
                  Handset, 68W Charger, USB Cable, Sim Tool, Protective Cover,
                  Guides
                </TableCell>
              </ColumnText>
              <ColumnText>
              ...
              <ColumnText>
                ...
                <TableCell>Marshmallow Blue</TableCell>
              </ColumnText>
              <ColumnText>
            ...
            <Box className={readMore == false ? "d-none" : "d-block"}>
              <SpecifiTable>
                ...
                <ColumnText>
                  ...
                  <TableCell>
                    Head: 1.04 W/Kg (at 1 g), Body: 1.05 W/Kg (at 1 g)
                  </TableCell>
                </ColumnText>
              </SpecifiTable>
            </Box>
