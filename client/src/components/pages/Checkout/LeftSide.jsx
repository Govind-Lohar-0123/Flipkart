        ...
        <Box className="bg-white">
          ...
          <StepStyle>
            ...
            <Box className="d-flex justify-content-space-between w-100 ">
              <Box>
                <Typography className="text-muted text-bold">
                  Login{" "}
                  <svg
                    height="20"
                    width="20"
                ...
                <Typography style={{ fontSize: "14px" }} className="my-1">
                  <Typography variant="span" className="text-dark text-bold ">
                    Govind Lohar
                  </Typography>{" "}
                  +9109024482
                </Typography>
