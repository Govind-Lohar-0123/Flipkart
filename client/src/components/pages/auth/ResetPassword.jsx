        ...
        <FormStyle>
          <div className="mb-3">
            <label for="exampleInputEmail1" className="form-label">
              <i className="fa-regular text-dark fa-envelope "></i> Email{" "}
            </label>
            <input
              type="email"
          ...
          <div className="mb-3">
            <label for="exampleInputPassword1" className="form-label">
              <i className="fa-solid fa-lock"></i>Enter New Password
            </label>
            <input
              type="password"
          ...
          <Box className="d-flex gap-2">
            <Button
              variant="contained"
              onClick={() => (window.location.href = clientUrl)}
              className="mt-3  bg-danger  text-bold w-50"
            >
              Cancel
            </Button>
            ...
            <Button
              ...
              className="mx-auto d-block text-bold p-0 w-50"
            >
              Change
            </Button>
          </Box>
