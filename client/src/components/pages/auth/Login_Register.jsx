...
import { sendOTP, userLogin, userRegister, verifyOTP } from "./userApi";
...
const accountinitialvalue = {
  ...
  singup: {
    ...
    subHeading: "Singup with your mobile number to get started",
  },
};
              ...
              {account == true ? (
                <Box className="px-4 mx-auto">
                  <h3 className="text-bold">
                    {accountinitialvalue.login.heading}
                  </h3>
                  <Typography
                    className="mt-3"
                    style={{ color: "#dbdbdb", fontSize: "18px" }}
                  >
                    {accountinitialvalue.login.subHeading}
                  </Typography>
                </Box>
              ) : (
                <Box className="px-4  mx-auto">
                  <h3 className="text-bold">
                    {accountinitialvalue.singup.heading}
                  </h3>
                  <Typography
                    className="mt-3"
                    style={{ color: "#dbdbdb", fontSize: "18px" }}
                  >
                    {accountinitialvalue.singup.subHeading}
                  </Typography>
                </Box>
              )}
            ...
            <Box className=" h-100 w-100">
              {account == true ? (
                <Box className="d-flex flex-direction-column h-100 justify-content-space-between">
                  <Box className="mt-5">
                    {result.type == true ? (
                      <div className="mx-5 alert alert-primary">
                        {result.msg}
                      </div>
                    ) : (
                      ""
                    ...
                    <FormControl className="w-100 px-5">
                      {isOpt == true ? (
                        <Box>
                          ...
                          <Typography
                            className="text-danger text-bold mt-1"
                            style={{ fontSize: "11px" }}
                          >
                          ...
                          <Box>
                            <input
                              type="checkbox"
                              onClick={() =>
                                setRemember(rememberMe ? false : true)
                              }
                            />
                  ...
                  <Typography
                    className="text-center text-primary mb-4 mt-2 text-bold "
                ...
                <Box className=" mt-2">
                  {result.type == true ? (
                    <div className="alert mx-5 alert-primary">{result.msg}</div>
                  ) : (
                    ""
                  )}
                  <Typography
                  ...
                  <FormControl className="d-flex flex-direction-column gap-2 w-100 px-5">
                    <TextField
                      ...
                      defaultValue={signData.firstname}
                      className="w-100"
                      name="firstname"
                    ...
                    <TextField
                      variant="standard"
                      onChange={signInputHandle}
                      defaultValue={signData.lastname}
                      className=" w-100 "
                      name="lastname"
                    ...
                    <TextField
                      variant="standard"
                      onChange={signInputHandle}
                      defaultValue={signData.username}
                      className=" w-100 "
                      name="username"
                    ...
                    <TextField
                      variant="standard"
                      onChange={signInputHandle}
                      defaultValue={signData.password}
                      className=" w-100 "
                      name="password"
                      label="Enter Password"
                    />
