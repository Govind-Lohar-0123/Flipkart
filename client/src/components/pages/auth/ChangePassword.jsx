...
export default function ChangePassword() {
  let [user_data, setUser_data] = React.useState({
  ...
  return (
    <div className="border-none">
      <Component sx={style} className="p-4 mt-5">
        ...
        <Typography variant="h5" className="text-center text-bold">
          Change Password
        </Typography>
        <form className="my-4">
          <div className="mb-3">
            <label for="exampleInputEmail1" className="form-label">
              <i className="fa-regular text-dark fa-envelope "></i> Enter
              Email{" "}
            </label>
            <input
              type="email"
          ...
          <div className="mb-3">
            <label for="exampleInputPassword1" className="form-label">
              <i className="fa-solid fa-lock"></i> Old Password
            </label>
            <input
              type="password"
              value={user_data.oldPassword}
          ...
          <div className="mb-3">
            ...
            <input
              type="password"
              value={user_data.confirmPassword}
              onChange={handleInput}
          ...
          <Box className="d-flex justify-content-space-between flex-wrap ">
            <Link to="/profile" component={routerLink}>
              <Button
                variant="contained"
                className="mt-3  bg-danger px-5 text-bold "
              >
                Cancel
              </Button>
            </Link>
            <Button
              ...
              className="mt-3  btn-primary text-bold "
            >
              Change Password
            </Button>
          </Box>
