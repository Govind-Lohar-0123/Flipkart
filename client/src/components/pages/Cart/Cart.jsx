            ...
            >
                    ...
                    <Box sx={style}>
                      ...
                      <Box className="">
                        ...
                        <Box
                          ...
                          style={{
                            background:
                              "url(https://rukminim1.flixcart.com/www/122/122/promos/21/06/2018/3bd082e2-af75-425a-834f-cb5100f35e3d.png?q=65) left no-repeat",
                          }}
                        >
                          <img width="100" />
                          <Link to="">
              ...
              <PlaceOrder className="w-100 bg-white d-flex p-4">
                <ButtonStyle variant="contained" size="large">
                  <Link component={RouterLink} className="text-white">
                    {" "}
                    PLACE ORDER{" "}
                  </Link>
                </ButtonStyle>
              ...
              <Box style={{ marginLeft: "26px" }}>
                <Box
                  ...
                  style={{
                    ...
                    background:
                      "url(https://static-assets-web.flixcart.com/fk-p-linchpin-web/fk-cp-zion/img/shield_b33c0c.svg) 0px 50% / 25px 31px no-repeat",
                  }}
                >
                  <Typography
                    style={{ fontSize: "14px", marginLeft: "50px" }}
                    className=" text-bold"
                  >
