      ...
      <Wrapper className="mt-4">
        ...
        <Grid container className="mt-3">
          <Grid item lg={2} md={3} sm={4}>
            <Box
              className=" w-75 text-center h-50 mt-2 "
              style={{ height: "80%" }}
            >
              <img
                loading="lazy"
                ...
                alt=""
                src="https://rukminim2.flixcart.com/image/144/144/kex5ci80/digital-combo/a/h/z/1-online-transaction-frauds-on-all-bank-accounts-credit-debit-original-imafvg2rkfrqhpzr.jpeg?q=90"
              />
            </Box>
          </Grid>
          <Grid item lg={9.8} md={9} sm={8} style={{ marginLeft: "auto" }}>
            <Box className="d-flex">
              <Box>
                ...
                <Typography
                  className="text-bold"
                  style={{ fontSize: "1.2rem", marginBlock: "1rem" }}
                >
                  ₹399
                </Typography>
                <Typography>
                  Get brand authorised repairs with free pickup and drop.
                  Absolutely no hidden charges <Link>!Know More</Link>
                </Typography>
              </Box>
