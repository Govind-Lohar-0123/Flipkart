    ...
    <>
      <StyledStack className="text-dark">
        {user != "" && user != null && user != undefined ? (
          <Box
            className="username"
            style={{ position: "relative", paddingBlock: "15px" }}
          >
            <Box>
              <Typography
                variant="contained"
                className="mx-2 text-bold bg-white text-primary p-1"
                style={{ fontSize: "1rem" }}
              >
                {user.firstname}
              </Typography>
            ...
            <UserList
              className="bg-white text-dark user-dropdown-list d-none "
              width="230px"
            >
                ...
                <ListItem>
                  <Link component={routerLink} to="/account">
                    <img
                      ...
                      height="17"
                    />
                    <Typography variant="span" className="mx-2">
                      My Profile
                    </Typography>
                  </Link>
                </ListItem>
          ...
          >
            <Box>
              <Link to="/login">
                <Typography
                  className=" bg-white text-primary text-bold px-4 py-1"
                  style={{ fontSize: "1rem" }}
                >
                  Login
                </Typography>
            ...
            >
              <List className="gap-1">
                <ListItem
                  className="p-3 d-flex align-item-center px-4"
                  style={{ justifyContent: "space-between" }}
                >
                  <Link to="/login" style={{ cursor: "pointer" }}>
                    <Typography className="text-muted text-bold" variant="span">
                      New Customer ?
                    </Typography>
                  </Link>
                  <Link to="/login" style={{ cursor: "pointer" }}>
        ...
        <Box>
          <Link
            to="/account/view-carts"
            component={routerLink}
            style={{ position: "relative" }}
            className=" text-white"
          >
            <StyledBadge variant="span" className="text-center">
              {cartSize != undefined ? cartSize.length : 0}
            </StyledBadge>
            <ShoppingCartIcon />
          </Link>
          <Link to="/view-carts" component={routerLink}>
            <Cart
              variant="span"
              style={{ fontSize: "1rem" }}
              className="mx-1 text-bold"
