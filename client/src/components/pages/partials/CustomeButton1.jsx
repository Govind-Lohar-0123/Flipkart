    ...
    <>
      <StyledStack className="text-dark">
        ...
        >
          ...
          >
            <StyledBadge variant="span" className="_2U7eDE">
          ...
          <Cart variant="span" style={{ fontSize: "1rem" }} className="mx-1">
            {" "}
            Cart
          </Cart>
        </Link>
        <Box>
          ...
          <Seller variant="span" style={{ fontSize: "1rem" }} className="mx-1 ">
            {" "}
            Become a Seller
          </Seller>
        </Box>
        <Box>
          <Box className="more-icon p-2">
            <More />{" "}
          </Box>

          <MoreList
            className="bg-white text-dark more-dropdown-list d-none"
            style={{ right: "35px" }}
          >
            <List className="gap-2">
              <ListItem>
