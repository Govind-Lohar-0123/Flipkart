...
import { removeToken } from "../auth/cookieAction";
import { removeUser } from "../auth/cookieAction";
...
export default function Dashboard() {
  ...
  return (
    <>
      <Component className="">
        <Box
          className="d-flex gap-3 bg-white px-3 py-2"
          style={{ boxShadow: "0 2px 4px 0 rgba(0, 0, 0, .08)" }}
        >
          <Link>
            <img
              height="50px"
          ...
          <Box>
            <Typography variant="small" style={{ fontSize: "12px" }}>
              Hello,
            </Typography>
        ...
        <Box
          className=" bg-white px-3 py-2 mt-3"
          style={{ boxShadow: "0 2px 4px 0 rgba(0, 0, 0, .08)" }}
        >
          <Box>
            <Typography className="text-bold" style={{ fontSize: "12px" }}>
              Frequently Visited:
            </Typography>
            <Link
              to="/account/orders"
            ...
            <Link
              to="/helpcentre"
              className="text-dark mx-3 text-muted"
              component={routerLink}
              fontSize="12px"
            >
              Help Center
