    ...
    <>
      <Box className="p-4">
        <Box className="d-flex gap-4 align-item-center justify-content-space-between">
          <Typography className="text-bold" style={{ fontSize: "19px" }}>
            Flipkart Gift Card
          </Typography>
          <Box
            className="d-flex gap-4 align-item-center text-bold"
            style={{ fontSize: "13px" }}
          >
            <a href="#buygiftcard" style={{ color: "#2874f0" }}>
              Buy a Gift Card
            </a>
            <Link
              to=""
              ...
              style={{ color: "#2874f0" }}
              onClick={() => setOpen({ isSet: true, type: false })}
            >
        ...
        <Box
          className="p-4 px-4 mt-3 text-center"
          style={{
            width: "100%",
            height: "500px",
            background: "linear-gradient(104deg, #34e062, #26bc4e)",
          }}
        >
          <Box className="d-flex gap-4 mx-3">
            <img
              ...
              width="55px"
              height="55px"
              src="https://static-assets-web.flixcart.com/fk-p-linchpin-web/fk-cp-zion/img/gift-box_c4b7bb.svg"
            />
            <Box
              className="d-flex align-item-center w-100 justify-content-space-between"
            ...
            >
              ...
              <Typography style={{ fontSize: "27px" }} className="text-white ">
                ₹50
              </Typography>
            </Box>
          </Box>
                    ...
                    <>
                      <TableRow>
                        <TableCell style={{ verticalAlign: "baseline" }}>
                          <Typography>Recived from</Typography>
                        </TableCell>
                        <TableCell align="">
        ...
        <div
          className="mt-3 px-4"
          onClick={() => setOpen({ isSet: true, type: true })}
          style={{
            borderRadius: "2px",
            color: "#2874f0",
            padding: "20px 0",
              ...
              {open.type == true ? (
                <Box sx={style}>
                  ...
                  <Box className="px-2 py-2">
                    ...
                    <Button
                      className="text-bold p-3 px-4 w-100 mt-3"
                      style={{ backgroundColor: " #2370f4" }}
                      variant="contained"
                      size="large"
                    >
        ...
        <Box className="mt-5 " id="buygiftcard">
          <Box className="d-flex my-2 gap-4 align-item-center justify-content-space-between">
            <Typography className="text-bold my-3" style={{ fontSize: "19px" }}>
            ...
            >
              ...
              <Link to="" component={routerLink}>
                <img
                  src="https://static-assets-web.flixcart.com/fk-p-linchpin-web/fk-cp-zion/img/qwikcilver_c036f3.png"
                  height="14"
                />
              </Link>
            </Box>
          ...
          >
            <Box className="px-4 ">
              <Box className="d-flex align-item-center gap-5" fontSize="14px">
                <Typography
                  variant="span"
                  className="py-3"
                  borderBottom={toggle ? "solid 4px blue" : " "}
                ...
                <Typography
                  variant="span"
                  className="py-3"
                  borderBottom={toggle == false ? "solid 4px blue" : " "}
            ...
            {toggle == false ? (
              <Box className="px-4 py-4" style={{ backgroundColor: "#f5faff" }}>
                <Typography style={{ fontSize: "13px" }} className="text-bold">
                ...
                <Box className="my-4">
                  ...
                  <Typography style={{ fontSize: "11px" }} className="my-1">
                    Have Flipkart Gift Card related queries ?{" "}
                    <span className="text-bold text-primary">Contact Us</span>
                  </Typography>
                ...
                <Grid container>
                  <Grid item lg={5.5}>
                    <Box className="d-flex flex-direction-column gap-4">
                      ...
                      <TextField
                        id="outlined-basic"
                        label="Gifter`s Name (Optional) *"
                        variant="outlined"
                        className="w-100"
                      />
                      <TextField
                        id="outlined-basic"
                        label="Write a message (Optional,100 Characters) *"
                        variant="outlined"
                        className="w-100"
                      />
          ...
          {toggle == false ? (
            <Button
              ...
              className="p-3 px-5 mt-4 text-bold text-white"
            >
              SUBMIT DETAILS
            </Button>
          ) : (
        ...
        <FAQsStyled className="mt-5">
          <Typography className="text-bold" style={{ fontSize: "16px" }}>
            FAQs
          </Typography>
          <Box>
            <Typography className="text-bold ">
            ...
            <ul style={{ listStyle: "disc" }} className="mx-3">
              <li>
                <Typography className="my-1">
                  ...
                  send the Flipkart Gift Card to.
                </Typography>
              </li>
              <li>
                <Typography className="my-1">
                  Select the value of the card you would like to purchase, then
                  click 'Proceed To Pay'.
                </Typography>
              </li>
              <li>
                <Typography className="my-1">
                  You'll now see the payment options. You can pay by Credit Card
                  / Debit Card / ATM Card / Netbanking. Proceed to pay using
                  your preferred choice. If you need to make any changes to the
                  Gift Card value, you can always click 'Edit' to modify it.
                </Typography>
              </li>
              <li>
                <Typography className="my-1">
                  Complete the checkout process to receive an email with the
                  Gift Card details.
                </Typography>
              </li>
            </ul>
          ...
          <Link className="text-bold mt-5" style={{ marginTop: "5rem" }}>
            View all FAQs
          </Link>
        </FAQsStyled>
