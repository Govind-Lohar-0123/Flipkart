...
export default function ManageAddress() {
  ...
  return (
    <>
      <Box>
        <Box
          className="mt-3 bg-white d-flex flex-direction-column justify-content-center align-item-center"
        ...
        >
          <Box className="text-center" style={{ fontSize: "14px" }}>
            ...
            <Typography
              className="text-bold my-2 mt-4 "
              style={{ fontSize: "18px" }}
            >
              No Addresses found in your account!
            </Typography>
            <Typography className="text-muted" style={{ fontSize: "14px" }}>
              Add a delivery address.
            </Typography>
            <Button
              variant="contained"
              className="my-3 p-3 px-4"
              style={{
