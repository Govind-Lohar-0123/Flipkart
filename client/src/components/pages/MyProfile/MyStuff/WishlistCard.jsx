        ...
        <Box>
          <Grid container lg={12} sm={10} xs={12}>
            <LeftComponent item lg={2} md={2} sm={6} xs={10} className="mb-4">
              ...
              >
                <Link className="w-100 h-50">
                  <Image
                    src="https://rukminim2.flixcart.com/image/312/312/xif0q/refrigerator-new/c/0/q/-original-imagyzrfxesmgjdq.jpeg?q=70"
                    alt=""
                  />
                </Link>
              </Box>
            ...
            <RightComponent item lg={10} md={10} sm={12}>
              <Box>
                <Box className="d-flex w-100 justify-content-space-between">
                  ...
                  >
                    {" "}
                    IFB 187 L Direct Cool Single Door 2 Star Refrigerator with
                    Powered by E-Tech,with Extraordinary Stora...
                  </Typography>
                  <Link>
                ...
                >
                  ...
                  <Typography variant="span" className="text-muted text-bold">
                    <del>₹17,650</del>
                  </Typography>
                  <Typography
                    variant="span"
