...
export default function ProfileInfo() {
  ...
  const saveUserInfoHandle = (e) => {
    ...
    if (name == "phone") {
      ...
      if (len == 10) {
        ...
        setResult({ type: true, msg: "Please Enter 10 Digit..." });
      }
      setEditMobile(true);
    } else {
  ...
  return (
    <>
      <ComponentBox>
        {result.type ? (
          <Box className="alert alert-primary w-50 mx-auto mt-5">
            {result.msg}
          </Box>
        ) : (
          ""
        ...
        <Box className="p-4">
          <Box>
            <Box className="d-flex gap-4 align-item-center ">
              ...
              <Typography
                onClick={() => setEditPerInfo(editPerInfo ? false : true)}
                ...
                <Box className="d-flex gap-3 mt-4 flex-wrap">
                  ...
                  >
                    <input
                      ...
                      name=" "
                      value={firstname}
                      className="border-none h-100 w-100"
                      style={{
                        width: "100%",
                        paddingLeft: "16px",
                        fontSize: "14px",
                ...
                <Box className="d-flex gap-3 my-4 flex-wrap">
                  ...
                  <FormControl variant="filled" style={{ height: "52px" }}>
                    ...
                    <FilledInput
                      ...
                      onChange={updateInputHandle}
                      name="lastname"
                      defaultValue={perInfo.lastname}
                    />
                  </FormControl>
                  <Button
                    variant="contained"
                    name="firstlastname"
                    onClick={saveUserInfoHandle}
                    size="large"
                    style={{
            ...
            <Box className="my-5">
              <Box className="d-flex gap-4 align-item-center ">
                ...
                <Typography
                  onClick={() => setEditMobile(editMobile ? false : true)}
                  className="text-primary text-bold"
                  style={{ fontSize: "14px", cursor: "pointer" }}
                >
                  Edit
            ...
            <Box>
              <Link
                ...
                className="bg-primary text-white text-bold p-2"
              >
                Change Password
              </Link>
            </Box>
            ...
            <FAQsStyled>
              ...
              <Box className="d-flex flex-direction-column gap-4 mt-5">
                <Button
                  ...
                  className="bg-primary mx-auto text-white "
                >
                  Deactivate Account
                </Button>
                <Button
                  ...
                  style={{ cursor: "pointer", width: "50%" }}
                  className="text-white mx-auto bg-danger "
                >
                  Delete Account
                </Button>
              </Box>
