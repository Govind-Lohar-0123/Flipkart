...
const RightComponent = styled(Grid)(({ theme }) => ({
  [theme.breakpoints.down("sm")]: {
    div: { width: "100%!important", paddingInline: "5px" },
  },
}));
export default function OrderDetails() {
  ...
  return (
    <>
      <Box style={{ width: "90%", marginTop: "120px" }} className="mx-auto">
        <Box>
          <Box className=" ">
            <Box className=" text-muted mt-3" style={{ fontSize: "12px" }}>
              <List
                className="d-flex flex-wrap align-item-center gap-3 p-0 m-0"
                style={{ justifyContent: "flex-start" }}
              >
                <ListItem className="px-0 py-0 w-auto">
                  <Link
                    to="/"
                ...
                <ListItem className="px-0  py-0 w-auto">
                  <Link
                    style={{ color: "#878787", transform: "rotate(180deg)" }}
                  >
                    <svg
                      width="5"
                      height="10"
                ...
                <ListItem className="px-0 py-0 w-auto">
                  <Link style={{ color: "#878787" }}>OD331415795331962300</Link>
                </ListItem>
              </List>
            </Box>
          </Box>
        ...
        <Box
          ...
          style={{ boxShadow: " 0px 2px 4px 0px rgba(0, 0, 0, .08)" }}
        >
          <Typography className="text-bold" style={{ fontSize: "15px" }}>
            Your Rewards
          </Typography>
        ...
        <Box
          ...
          style={{
            ...
            boxShadow: " 0px 2px 4px 0px rgba(0, 0, 0, .08)",
          }}
        >
          <Box style={{ marginLeft: "4%" }}>
            <Grid container>
              <Grid item lg={3} md={3} sm={10}>
                <Box className="d-flex gap-3 ">
                  <Link style={{ height: "75px", width: "75px" }}>
                    <img
                      ...
                      src="https://rukminim2.flixcart.com/image/200/200/xif0q/recharge-bill-payment/w/h/j/-original-imagqjnvmr86drxt.jpeg?q=90"
                    />
                  </Link>
                  <Box>
                    <Typography style={{ fontSize: "14px" }}>
                    ...
                    <Box
                      className="mt-2"
                      style={{ color: " #878787", fontSize: "12px" }}
                    >
                      <span className="mx-2">9xxxxx1239</span>
                    </Box>
                    <Box className="d-flex align-item-center gap-2 text-bold mt-2">
                      ...
                      <Box className="d-flex align-item-center">
                        ...
                        <img
                          style={{ height: "16px" }}
                          src="https://static-assets-web.flixcart.com/fk-p-linchpin-web/fk-cp-zion/img/lockinCoinNew_79b3fb.svg"
                        />
                      </Box>
                      <span>15</span>
                      <QuestionMark
              ...
              <RightComponent item lg={9} md={9} sm={12}>
                <Box className="d-flex  gap-2 mt-3 flex-wrap">
                  ...
                  >
                    ...
                    >
                      <Typography variant="span" style={{ color: "#26a541" }}>
                        Payment successful
                      </Typography>
                      <Typography
                        variant="span"
                    ...
                    <Box className="d-flex justify-content-space-between">
                      <Typography variant="span" style={{ color: "#878787" }}>
                        Sun, 2nd Jun
                      </Typography>
                      <Typography variant="span">Sun, 2nd Jun</Typography>
                    </Box>
                    <Box
                      className="_1L+CJ0 eRsKER"
                      style={{
                        left: "0%",
                        width: 0,
                        height: 0,
                  ...
                  <Box>
                    <Link className="d-flex align-item-center gap-2">
                      ...
                      <Typography
                        style={{ fontSize: "13px", color: "#2874f0" }}
                        className="text-bold"
                      >
                        Rate &amp; Review Product
                      </Typography>
        ...
        >
          ...
          <Grid container className="mt-2">
            <Grid item lg={3} md={6} sm={6} xs={10} className="mb-2 mx-auto">
              <Box>
                <Typography className="" style={{ color: " #878787" }}>
                  Transaction ID
                </Typography>
                <Typography className="" style={{ fontSize: "12px" }}>
                  {" "}
                  HGADP152F10796167784
                </Typography>
              </Box>
            </Grid>
            <Grid item lg={3} md={6} sm={6} xs={10} className="mb-2 mx-auto">
