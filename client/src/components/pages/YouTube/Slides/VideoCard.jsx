  ...
  return (
    <>
      <Link component={routerLink} to="/detail-video">
        <Cart
          className="text-center text-dark  mt-4 h-100 w-100 border-none"
        ...
        >
          ...
          <CartContent className="d-flex align-item-center gap-3 py-2  px-3 border-none">
            ...
            <Box className="text-start">
              <Typography style={{ fontSize: "1rem" }} className="text-bold ">
                Shrimp and Chorizo Paella
              </Typography>
              <Typography style={{ fontSize: "15px" }} className="text-muted ">
                September 14, 2016
              </Typography>
